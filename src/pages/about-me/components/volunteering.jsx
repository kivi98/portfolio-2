              ...
              >
                <li style={{ color: 'text.dark' }}>
                  ...
                  >
                    ...
                    Chairperson, leading strategic vision, program development,
                    and mentoring to advance the mission of IEEE Innovation
                    Nation Sri Lanka.
                  </Typography>
                </li>
                <li>
              ...
              >
                <li style={{ color: 'text.dark' }}>
                  ...
                  >
                    ...
                    Chairperson, providing strategic leadership and representing
                    member interests, demonstrating trust and leadership
                    prowess.
                  </Typography>
                </li>
                <li>
                ...
                <li>
                  <Typography variant={'caption'} sx={{ p: 0 }}>
                    Member (2021 - 2022): Actively engaged in branch activities
                    and event organization, fostering a vibrant community of
                    learners.
                  </Typography>
                </li>
              </ul>
